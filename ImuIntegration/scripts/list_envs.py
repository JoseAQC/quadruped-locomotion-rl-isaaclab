...
All the environments are registered in the `ImuIntegration` extension. They start
...
import ImuIntegration.tasks  # noqa: F401


def main():
    """Print all environments registered in `ImuIntegration` extension."""
