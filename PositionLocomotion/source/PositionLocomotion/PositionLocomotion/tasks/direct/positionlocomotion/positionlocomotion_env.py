...
from .positionlocomotion_env_cfg import PositionlocomotionEnvCfg
from isaaclab_tasks.direct.locomotion.locomotion_env import LocomotionEnv

class PositionlocomotionEnv(LocomotionEnv):
    cfg: PositionlocomotionEnvCfg

    def __init__(self, cfg: PositionlocomotionEnvCfg, render_mode: str | None = None, **kwargs):
